...
- [ ] Агентный пайплайн: единый чат с моделью, где она сама решает искать/читать/отвечать и делает toolcalls в рамках одной conversation history
...
- [ ] Итеративный поиск: агент сам предлагает дополнительные запросы после чтения источников
